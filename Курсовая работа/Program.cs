...
namespace Курсовая_работа
{
    internal static class Program
    {
        ...
        {   
            ...
            Worker worker1 = new Worker("I", "S", "0", new DateTime(1999, 5, 6), new Credentials("vdаааа", "sddssS1a"), Status.Admin);
            Worker worker2 = new Worker("I", "S", "0", new DateTime(1999, 5, 6), new Credentials("vdаааа", "sddssS1a"), Status.Admin);
